                      ...
                      div(
                        ...
                        div(
                          ...
                          label(
                            ...
                            req.__("Periodic background Sync interval")
                          ),
                          input({
                            type: "text",
                            class: "form-control",
                        ...
                        i(
                          req.__(
                            "This is the min-interval between background sync runs in minutes. " +
                            "Especially on iOS the time can vary depending on system conditions. " +
                            "The value must be at least 15 minutes. To disable it, leave it empty or set it to 0."
                          )
                        )
                      )
                    )
